...
#This script is to run and test dpdk pktgen. It is written for a 1Gb Ethernet cable.
...
#You need to know the PCI bus of your 1Gb ethernet controller (in my case it was 0000:02:00.0), run "lscpi | greth Eth""
...
./app/app/x86_64-native-linuxapp-gcc/pktgen -l 0-3 -n 4 -- -T -P -m "1.0" -f themes/white-black.theme
